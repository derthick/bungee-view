...
public class Inflector {
	...
	protected class Rule {
		...
		protected Rule(final String _expression, final String _replacement) {
			expression = _expression;
			replacement = _replacement != null ? _replacement : "";
			expressionPattern = Pattern.compile(expression,
		...
		protected String apply(final String input) {
			final Matcher matcher = this.expressionPattern.matcher(input);
			if (!matcher.find()) {
				return null;
			}
	 ...
	 */
	public String pluralizex(final Object word) {
		if (word == null) {
			return null;
		}
	...
	public static String pluralize(final Object word) {
		return INSTANCE.pluralizex(word);
	}

	public static String pluralize(final Object word, final int count) {
		if (word == null) {
			return null;
		}
		if (count == 1 || count == -1) {
	 ...
	 */
	public String singularizex(final Object word) {
		if (word == null) {
			return null;
		}
		final String wordStr = word.toString().trim();
	...
	public static String singularize(final Object word) {
		return INSTANCE.singularizex(word);
	}
	 ...
	 */
	public static String underscore(final String camelCaseWord,
			final char... delimiterChars) {
	 ...
	 */
	public static String humanize(final String lowerCaseAndUnderscoredWords,
	 ...
	 */
	public static String ordinalize(final int number) {
	...
	public void addIrregular(final String singular, final String plural) {
		...
		final String singularRemainder = singular.length() > 1 ? singular
				.substring(1) : "";
		final String pluralRemainder = plural.length() > 1 ? plural
						.substring(1) : "";
